...
# Create a dedicated cluster and disable its connect address.
# NOTE: disabling the connect address requires a private link (Enterprise plan or
...
# populated before setting connect_address_enabled = false, otherwise the apply
